    ...
    <div class="col-sm-offset-2 col-md-offest-2">
        ...
        <div  class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6">
                    <input type="password" class="form-control" id="inputPassword" placeholder="don't input invalid characters" />
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="startLogin()">purchaser login</button>
                </div>
            </div>
        </div>
        <br/>
