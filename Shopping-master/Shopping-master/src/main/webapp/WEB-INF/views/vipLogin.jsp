        ...
        <div  class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="startLogin()">vip登录</button>
                </div>
            </div>
        </div>
        <br/>
...
<script type="text/javascript">
    function startLogin() {
        ...
        if(loginResult == 'success'){
            ...
            layer.confirm('去商家那登录', {icon: 1, title:'你是商家',btn:['去商家登录','算了吧']},
                function(){
                    //此处要改
            ...
            layer.confirm('去普通买家那登录', {icon: 1, title:'你不是vip',btn:['去普通买家登录','算了吧']},
                function(){
                    //此处要改
