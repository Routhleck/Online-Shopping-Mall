        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-5 detail-x">
                <table class="table table-striped">
                    ...
                    <c:if test="${currentUser.role == 0||currentUser.role == 2}">
                    <tr>
                        <th>购买数量</th>
                        <td>
                            <div class="btn-group" role="group">
                               <button type="button" class="btn btn-default" onclick="subCounts()">-</button>
                                <input type="text" id="productCounts" type="button" class="btn btn-default" value="1"></input>
